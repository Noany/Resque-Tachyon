...
public class Command implements org.apache.thrift.TBase<Command, Command._Fields>, java.io.Serializable, Cloneable, Comparable<Command> {
  ...
  //zengdan
  private static final org.apache.thrift.protocol.TField M_PARTITIONINFOS_FIELD_DESC = new org.apache.thrift.protocol.TField("mPartitionInfos", TType.SET, (short)3);
  ...
  public Set<PartitionInfo> mPartitionInfos; //zengdan
  ...
  public enum _Fields implements org.apache.thrift.TFieldIdEnum {
    ...
    M_PARTITIONINFOS((short)3, "mPartitionInfos"); //zengdan
    ...
    public static _Fields findByThriftId(int fieldId) {
      switch(fieldId) {
        ...
        case 2: // M_DATA
          return M_DATA;
        case 3:
          return M_PARTITIONINFOS; //zengdan
        default:
          return null;
      }
    }
  ...
  static {
    ...
    //zengdan
    tmpMap.put(_Fields.M_PARTITIONINFOS, new org.apache.thrift.meta_data.FieldMetaData("mPartitionInfos", org.apache.thrift.TFieldRequirementType.DEFAULT,
            new org.apache.thrift.meta_data.SetMetaData(TType.SET,
    ...
    List<Long> mData)
  {
    ...
    this.mData = mData;
    this.mPartitionInfos = new HashSet<PartitionInfo>(); //zengdan
  }
  ...
  public Command(
          CommandType mCommandType,
          List<Long> mData,
          Set<PartitionInfo> mPartitionInfos)
  {
    this();
    this.mCommandType = mCommandType;
    this.mData = mData;
    this.mPartitionInfos = mPartitionInfos;
  }
  ...
  public Command(Command other) {
    ...
    if(other.isSetMPartitionInfos()){ //zengdan
      this.mPartitionInfos = new HashSet<PartitionInfo>(other.mPartitionInfos);
    }
  }
  ...
  public void clear() {
    ...
    this.mData = null;
    this.mPartitionInfos = null; //zengdan
  }
  ...
  //zengdan
  public Set<PartitionInfo> getMPartitionInfos() {
    return this.mPartitionInfos;
  }

  //zengdan
  public Command setMPartitionInfos(Set<PartitionInfo> mPartitionInfos) {
    this.mPartitionInfos = mPartitionInfos;
    return this;
  }

  //zengdan
  public void unsetMPartitionInfos() {
    this.mPartitionInfos = null;
  }

  //zengdan
  public boolean isSetMPartitionInfos() {
    return this.mPartitionInfos != null;
  }

  //zengdan
  public void setMPartitionInfosIsSet(boolean value) {
    if (!value) {
      this.mPartitionInfos = null;
    }
  }
  ...
  public void setFieldValue(_Fields field, Object value) {
    ...
    case M_DATA:
      ...
      break;
    case M_PARTITIONINFOS: //zengdan
      if (value == null) {
        unsetMPartitionInfos();
      } else {
        setMPartitionInfos((Set<PartitionInfo>) value);
      }
      break;
  ...
  public boolean equals(Command that) {
    ...
    //zengdan
    boolean this_present_mPartitionInfos = true && this.isSetMPartitionInfos();
    boolean that_present_mPartitionInfos = true && that.isSetMPartitionInfos();
    if (this_present_mPartitionInfos || that_present_mPartitionInfos) {
      if (!(this_present_mPartitionInfos && that_present_mPartitionInfos))
        return false;
      if (!this.mPartitionInfos.equals(that.mPartitionInfos))
        return false;
    }
  ...
  public int compareTo(Command other) {
    ...
    //zengdan
    lastComparison = Boolean.valueOf(isSetMPartitionInfos()).compareTo(other.isSetMPartitionInfos());
    if (lastComparison != 0) {
      return lastComparison;
    }
    if (isSetMPartitionInfos()) {
      lastComparison = org.apache.thrift.TBaseHelper.compareTo(this.mPartitionInfos, other.mPartitionInfos);
      if (lastComparison != 0) {
        return lastComparison;
      }
    }
  ...
  public String toString() {
    ...
    //zengdan
    if (!first) sb.append(", ");
    sb.append("mPartitionInfos:");
    if (this.mPartitionInfos == null) {
      sb.append("null");
    } else {
      sb.append(this.mPartitionInfos);
    }
    first = false;
    //zengdan
  ...
  private static class CommandStandardScheme extends StandardScheme<Command> {
      ...
      while (true)
      {
        ...
        switch (schemeField.id) {
          ...
          case 2: // M_DATA
            ...
            break;
          case 3: // M_PARTITIONINFOS
            if (schemeField.type == TType.SET) {
              {
                org.apache.thrift.protocol.TSet _map40 = iprot.readSetBegin();
                struct.mPartitionInfos = new HashSet<PartitionInfo>(_map40.size);
                for (int _i41 = 0; _i41 < _map40.size; ++_i41)
                {
                  PartitionInfo _elem42 = new PartitionInfo();
                  _elem42.read(iprot);
                  struct.mPartitionInfos.add(_elem42);
                }
                iprot.readSetEnd();
              }
              struct.setMPartitionInfosIsSet(true);
            } else {
              org.apache.thrift.protocol.TProtocolUtil.skip(iprot, schemeField.type);
            }
            break;
    ...
    public void write(org.apache.thrift.protocol.TProtocol oprot, Command struct) throws org.apache.thrift.TException {
      ...
      if (struct.mPartitionInfos != null) { //zengdan
        oprot.writeFieldBegin(M_PARTITIONINFOS_FIELD_DESC);
        {
          oprot.writeSetBegin(new org.apache.thrift.protocol.TSet(TType.STRUCT, struct.mPartitionInfos.size()));
          for (PartitionInfo _iter43 : struct.mPartitionInfos)
          {
            _iter43.write(oprot);
          }
          oprot.writeSetEnd();
  ...
  private static class CommandTupleScheme extends TupleScheme<Command> {
    ...
    public void write(org.apache.thrift.protocol.TProtocol prot, Command struct) throws org.apache.thrift.TException {
      ...
      //zengdan change 2 to 3 in writBitSet
      ...
      if (struct.isSetMPartitionInfos()) {//zengdan
        {
          oprot.writeI32(struct.mPartitionInfos.size());
          for (PartitionInfo _iter44 : struct.mPartitionInfos)
          {
            _iter44.write(oprot);
          }
        }
    ...
    public void read(org.apache.thrift.protocol.TProtocol prot, Command struct) throws org.apache.thrift.TException {
      ...
      if (incoming.get(2)) {
        {
          org.apache.thrift.protocol.TSet _map45 = new org.apache.thrift.protocol.TSet(TType.STRUCT, iprot.readI32());
          struct.mPartitionInfos = new HashSet<PartitionInfo>(_map45.size);
          for (int _i46 = 0; _i46 < _map45.size; ++_i46)
          {
            PartitionInfo _elem47 = new PartitionInfo();
            _elem47.read(iprot);
            struct.mPartitionInfos.add(_elem47);
          }
        }
        struct.setMPartitionInfosIsSet(true);
      }
