...
interface BlockStore {
  ...
  //zengdan
  List<TempBlockMeta> createPartitionMeta(long userId, PartitionInfo partition,
  ...
  //zengdan
  void movePartition(long userId, PartitionInfo partition, BlockStoreLocation newLocation)
          throws IOException;
