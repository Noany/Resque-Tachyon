...
public class BlockMetadataManagerView {
  ...
  //zengdan
  public synchronized Set<PartitionInfo> getBlockIdToBenefit() {
    return mMetadataManager.getBlockIdToBenefit();
  }
  ...
  //zengdan
  public List<StorageTierView> getTierViewsBelowLevel(int level) throws IOException {
    // TODO: similar concern as in getTierView
    return mTierViews.subList(level + 1, mTierViews.size());
  }
