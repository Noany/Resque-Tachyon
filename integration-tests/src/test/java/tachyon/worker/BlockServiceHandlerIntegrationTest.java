...
public class BlockServiceHandlerIntegrationTest {
  ...
  public final void before() throws IOException {
    ...
    System.setProperty("tachyon.worker.tieredstore.level0.alias", "MEM");
    System.setProperty("tachyon.worker.tieredstore.level0.dirs.path", "/mnt/ramdisk");
    System.setProperty("tachyon.worker.tieredstore.level0.dirs.quota", "512MB");
    System.setProperty("tachyon.worker.tieredstore.level1.alias", "HDD");
    System.setProperty("tachyon.worker.tieredstore.level1.dirs.path", "/Users/zengdan/tachyon-0.7.1/diskData");
    System.setProperty("tachyon.worker.tieredstore.level1.dirs.quota", "50GB");
    System.setProperty("tachyon.worker.evict.strategy", "REUSE");
